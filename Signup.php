			...
			<div class="row">
				...
				<div id="msg"></div>
					<div class="row">
							...
							<div class="form-group col-md-6">
								<input type="text" class="form-control" placeholder="Họ" name='lastname'>
							</div>
						</div>
						<div class="row">
						...
						<b><small class="text-muted"><b>Giới tính</b></small></b>
						<div class="row">
					...
					<div class="col-md-6">
							<div class="form-group">
								<input type="text" name="contact" class="form-control form-control-sm"  placeholder="Liên hệ">
							</div>
							<div class="form-group">
						...
						<div class="row justify-content-center">
							<button class="btn btn-block btn-success col-sm-5 align-self-center"><b>Đăng ký</b></button>
						</div>
	</form>
</div>
<style>
